...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file://C:/Users/Todd/Developer/ama/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/Todd/Developer/ama/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file://C:/Users/Todd/Developer/ama/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
...
import destr, { destr as destr$1 } from 'file://C:/Users/Todd/Developer/ama/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/Users/Todd/Developer/ama/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/Todd/Developer/ama/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/Todd/Developer/ama/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/Todd/Developer/ama/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/Todd/Developer/ama/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/Todd/Developer/ama/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://C:/Users/Todd/Developer/ama/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/Todd/Developer/ama/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/Todd/Developer/ama/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/Todd/Developer/ama/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/Todd/Developer/ama/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/Todd/Developer/ama/node_modules/unstorage/drivers/fs.mjs';
...
import { SourceMapConsumer } from 'file://C:/Users/Todd/Developer/ama/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/Todd/Developer/ama/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/Todd/Developer/ama/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://C:/Users/Todd/Developer/ama/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/Users/Todd/Developer/ama/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Users/Todd/Developer/ama/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/Todd/Developer/ama/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Todd/Developer/ama","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Todd/Developer/ama/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', file_58_47_47_47C_58_47Users_47Todd_47Developer_47ama_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"file:///C:/Users/Todd/Developer/ama/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"C:/Users/Todd/Developer/ama/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Todd/Developer/ama/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Todd/Developer/ama/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/Todd/Developer/ama/.data/kv"}));
...
const rootDir = "C:/Users/Todd/Developer/ama";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Ask me anything, anonymously."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Ask Me Anything Anonymously"};
...
const _20qJuyyROQcGVr18I9lF9m8LmFbL2EAMQcEX2RMBb9o = (nitroApp) => {
...
const plugins = [
  _20qJuyyROQcGVr18I9lF9m8LmFbL2EAMQcEX2RMBb9o,
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"1dc9e-xBmSFphs8MI/lW4/T1P6l2qA+xg\"",
    "mtime": "2026-06-01T03:49:34.964Z",
    "size": 122014,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"75fd9-XUPQ+2RIISTTOMl8YOJ0CVKZg0w\"",
    "mtime": "2026-06-01T03:49:34.964Z",
    "size": 483289,
    "path": "index.mjs.map"
  }
...
const _P1ONdI = eventHandler((event) => {
...
const _lazy_0oEC4q = () => Promise.resolve().then(function () { return bluesky_post$1; });
const _lazy_nDvNwU = () => Promise.resolve().then(function () { return _id__get$3; });
const _lazy_jNwnvr = () => Promise.resolve().then(function () { return questions_get$1; });
const _lazy_T9Urk2 = () => Promise.resolve().then(function () { return questions_post$1; });
const _lazy_JO2uwu = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_HG9qK5 = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_NG2mII = () => Promise.resolve().then(function () { return _id__patch$1; });
const _lazy_6A6g8X = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _P1ONdI, lazy: false, middleware: true, method: undefined },
  { route: '/api/bluesky', handler: _lazy_0oEC4q, lazy: true, middleware: false, method: "post" },
  { route: '/api/og/:id', handler: _lazy_nDvNwU, lazy: true, middleware: false, method: "get" },
  { route: '/api/questions', handler: _lazy_jNwnvr, lazy: true, middleware: false, method: "get" },
  { route: '/api/questions', handler: _lazy_T9Urk2, lazy: true, middleware: false, method: "post" },
  { route: '/api/questions/:id', handler: _lazy_JO2uwu, lazy: true, middleware: false, method: "delete" },
  { route: '/api/questions/:id', handler: _lazy_HG9qK5, lazy: true, middleware: false, method: "get" },
  { route: '/api/questions/:id', handler: _lazy_NG2mII, lazy: true, middleware: false, method: "patch" },
  { route: '/__nuxt_error', handler: _lazy_6A6g8X, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_6A6g8X, lazy: true, middleware: false, method: undefined }
];
...
const bluesky_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: bluesky_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const _id__get$2 = defineEventHandler(async (event) => {
  ...
  const { data: question, error } = await supabase.from("questions").select("*").eq("id", id).single();
  if (error || !question) {
...
const questions_get = defineEventHandler(async (event) => {
  const supabase = useServerSupabase();
  const query = getQuery$1(event);
  let req = supabase.from("questions").select("*").order("created_at", { ascending: false });
  if (query.admin !== "true") {
...
const questions_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: questions_get
}, Symbol.toStringTag, { value: 'Module' }));

const questions_post = defineEventHandler(async (event) => {
  var _a;
  const body = await readBody(event);
  if (!((_a = body == null ? void 0 : body.question) == null ? void 0 : _a.trim())) {
  ...
  const supabase = useServerSupabase();
  const { data, error } = await supabase.from("questions").insert({ question: body.question.trim(), answered: false }).select().single();
  if (error) throw createError({ statusCode: 500, message: error.message });
  return data;
});

const questions_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: questions_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const _id__get = defineEventHandler(async (event) => {
  const id = getRouterParam(event, "id");
  const supabase = useServerSupabase();
  const { data, error } = await supabase.from("questions").select("*").eq("id", id).eq("answered", true).single();
  if (error || !data) {
    throw createError({ statusCode: 404, message: "Question not found." });
  }
  return data;
...
const _id__patch = defineEventHandler(async (event) => {
  ...
  const { data, error } = await supabase.from("questions").update({
    answered: (_a = body.answered) != null ? _a : true,
    answer: (_b = body.answer) != null ? _b : null
